...
# below).
#
# The linear examples use the basic line equation
#         pts = slope * Score + intercept
# where the slope and intercept are found in the tibble below.

library(tidyverse)

rounds <- tribble(
  # Columns below:
  # round name, equipment class, max possible score, minimum score to earn points,
  # "a" value from the exponential model, slope from linear model, intercept from
  # linear model, curve type (e.g., "exp" or "linear")
