...
rounds <- tribble(
  ...
  "25-Meter 1200", "Compound", 1200, 1080, 1154, 0.026899, 1.550, -1692.014, "exp",
  "25-Meter 1200", "Recurve", 1200, 934, 1094, 0.012048, 0.702, -670.346, "linear",
  "25-Meter 600", "Compound", 600, 540, 577, 0.053798, 3.101, -1692.014, "exp",
  "25-Meter 600", "Recurve", 600, 467, 547, 0.024097, 1.404, -670.346, "linear",
  ...
  "NFAA Animal 294", "Compound", 294, 280, 290, 0.189326, 11.730, -3302.119, "linear",
  "NFAA Animal 294", "Recurve", 294, 262, 289, 0.194967, 3.314, -882.674, "exp",
  "NFAA Animal 588", "Compound", 588, 561, 580, 0.094663, 5.865, -3302.119, "linear",
  ...
  "NFAA Indoor 360", "Recurve", 360, 236, 312, 0.021531, 1.355, -322.489, "linear",
  "NFAA Indoor 720", "Compound", 720, 657, 717, 0.050447, 1.837, -1232.857, "exp",
  "NFAA Indoor 720", "Recurve", 720, 472, 625, 0.010765, 0.678, -322.489, "linear",
  ...
  "USA Outdoor 1440", "Recurve", 1440, 861, 1252, 0.004729, 0.270, -241.103, "linear",
  "USA Outdoor 720", "Compound", 720, 574, 698, 0.019843, 0.841, -499.809, "exp",
  "USA Outdoor 720", "Recurve", 720, 430, 626, 0.009458, 0.540, -241.103, "linear",
